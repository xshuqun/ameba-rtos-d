...
checksum = 0;
with open("../../../../../project/realtek_amebaD_va0_example/EWARM-RELEASE/Debug/Exe/km4_image/km0_km4_image2.bin", "rb") as f:
    byte = f.read(1)
...
imagelen = os.path.getsize("../../../../../project/realtek_amebaD_va0_example/EWARM-RELEASE/Debug/Exe/km4_image/km0_km4_image2.bin")
...
img2_bin = open('../../../../../project/realtek_amebaD_va0_example/EWARM-RELEASE/Debug/Exe/km4_image/km0_km4_image2.bin', 'br').read()
...
ota1_bin = open('../../../../../project/realtek_amebaD_va0_example/EWARM-RELEASE/Debug/Exe/km4_image/km0_km4_image2.bin', 'br').read()
